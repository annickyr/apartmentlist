...
var KintoneRestAPIError = /** @class */ (function (_super) {
    ...
    KintoneRestAPIError.findBulkRequestIndex = function (results) {
    ...
    KintoneRestAPIError.buildErrorResponseDateWithIndex = function (error) {
        if ("results" in error.data) {
            var bulkRequestIndex = KintoneRestAPIError.findBulkRequestIndex(error.data.results);
            var data = error.data.results[bulkRequestIndex];
            return { data: data, bulkRequestIndex: bulkRequestIndex };
        }
