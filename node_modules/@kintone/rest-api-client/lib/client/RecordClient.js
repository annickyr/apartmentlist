...
var RecordClient = /** @class */ (function () {
    function RecordClient(client, guestSpaceId) {
        this.client = client;
    ...
    RecordClient.prototype.getRecords = function (params) {
        ...
        if (params.query) {
            ...
            var result = params.query.match(regexp);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (fields && fields.length > 0 && fields.indexOf("$id") === -1) {
                    fields = __spreadArrays(fields, ["$id"]);
                }
    ...
    RecordClient.prototype.getAllRecordsRecursiveWithId = function (params, id, records) {
        return __awaiter(this, void 0, void 0, function () {
            var GET_RECORDS_LIMIT, condition, rest, conditionQuery, query, result, allRecords, lastId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
